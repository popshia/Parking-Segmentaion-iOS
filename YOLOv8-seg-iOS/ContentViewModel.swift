...
//  YOLOv8-seg-iOS
//
//  Created by Marcel Opitz on 05.18.23.
//  Modified by Noah on 06.30.25.
//
...
class ContentViewModel: ObservableObject {
    ...
    var classNames: [String] = ["other_car", "other_scooter", "legal_car", "illegal_scooter", "illegal_car", "legal_scooter"]
...
//            }
            ...
            guard let model = try? parking_640(configuration: config) else {
                print("failed to init model")
                return
            }
            ...
            if let classLabels = model.model.modelDescription
                .classLabels?.compactMap({ $0 as? String }) {
                self.classNames = classLabels
            }
